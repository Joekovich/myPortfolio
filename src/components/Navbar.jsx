    ...
    <div className="fixed w-full h-[85px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
            ...
            <li className='w-[160px] h-[60] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#9572f5ee]'>
                <a className='flex justify-between items-center w-full text-gray-300 ' href="/">Email <HiOutlineMail size={30}/></a>
            </li>
            <li className='w-[160px] h-[60] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#575c54]'>
